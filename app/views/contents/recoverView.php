    ...
    <body class="recoverPage">
        ...
        <div class="container">
            ...
            <div class="recoverPageForm d-block text-center">
                    ...
                    <form method="post" action="/recoverpass" class="">
                        <div class="form-group text-center">
                            <input type="email" class="form-control" placeholder="Informe o e-mail" name="recoverEmail" required>
                            <button type="submit" class="recoverPageBtn mt-3">Enviar solicitação</button>
                        </div>  
                    </form>
                </div>
